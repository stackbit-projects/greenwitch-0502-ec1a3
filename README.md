...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/608ec1a33d6af800161846f4
...
To start editing your site, you can use the Sanity interface at https://greenwitch-0502-ec1a3.sanity.studio/.
...
Generated at `2021-05-02T15:56:03.901Z` by Stackbit version `0.3.51`.